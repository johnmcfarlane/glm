...
namespace detail
{
	...
	GLM_FUNC_QUALIFIER glm::uint64 bitfieldInterleave(glm::uint32 x, glm::uint32 y)
	{
		...
		REG1 = ((REG1 << 16) | REG1) & UINT64_C(0x0000FFFF0000FFFF);
		REG2 = ((REG2 << 16) | REG2) & UINT64_C(0x0000FFFF0000FFFF);

		REG1 = ((REG1 <<  8) | REG1) & UINT64_C(0x00FF00FF00FF00FF);
		REG2 = ((REG2 <<  8) | REG2) & UINT64_C(0x00FF00FF00FF00FF);

		REG1 = ((REG1 <<  4) | REG1) & UINT64_C(0x0F0F0F0F0F0F0F0F);
		REG2 = ((REG2 <<  4) | REG2) & UINT64_C(0x0F0F0F0F0F0F0F0F);

		REG1 = ((REG1 <<  2) | REG1) & UINT64_C(0x3333333333333333);
		REG2 = ((REG2 <<  2) | REG2) & UINT64_C(0x3333333333333333);

		REG1 = ((REG1 <<  1) | REG1) & UINT64_C(0x5555555555555555);
		REG2 = ((REG2 <<  1) | REG2) & UINT64_C(0x5555555555555555);
	...
	GLM_FUNC_QUALIFIER glm::uint64 bitfieldInterleave(glm::uint16 x, glm::uint16 y, glm::uint16 z)
	{
		...
		REG1 = ((REG1 << 32) | REG1) & UINT64_C(0xFFFF00000000FFFF);
		REG2 = ((REG2 << 32) | REG2) & UINT64_C(0xFFFF00000000FFFF);
		REG3 = ((REG3 << 32) | REG3) & UINT64_C(0xFFFF00000000FFFF);

		REG1 = ((REG1 << 16) | REG1) & UINT64_C(0x00FF0000FF0000FF);
		REG2 = ((REG2 << 16) | REG2) & UINT64_C(0x00FF0000FF0000FF);
		REG3 = ((REG3 << 16) | REG3) & UINT64_C(0x00FF0000FF0000FF);

		REG1 = ((REG1 <<  8) | REG1) & UINT64_C(0xF00F00F00F00F00F);
		REG2 = ((REG2 <<  8) | REG2) & UINT64_C(0xF00F00F00F00F00F);
		REG3 = ((REG3 <<  8) | REG3) & UINT64_C(0xF00F00F00F00F00F);

		REG1 = ((REG1 <<  4) | REG1) & UINT64_C(0x30C30C30C30C30C3);
		REG2 = ((REG2 <<  4) | REG2) & UINT64_C(0x30C30C30C30C30C3);
		REG3 = ((REG3 <<  4) | REG3) & UINT64_C(0x30C30C30C30C30C3);

		REG1 = ((REG1 <<  2) | REG1) & UINT64_C(0x9249249249249249);
		REG2 = ((REG2 <<  2) | REG2) & UINT64_C(0x9249249249249249);
		REG3 = ((REG3 <<  2) | REG3) & UINT64_C(0x9249249249249249);
	...
	GLM_FUNC_QUALIFIER glm::uint64 bitfieldInterleave(glm::uint16 x, glm::uint16 y, glm::uint16 z, glm::uint16 w)
	{
		...
		REG1 = ((REG1 << 24) | REG1) & UINT64_C(0x000000FF000000FF);
		REG2 = ((REG2 << 24) | REG2) & UINT64_C(0x000000FF000000FF);
		REG3 = ((REG3 << 24) | REG3) & UINT64_C(0x000000FF000000FF);
		REG4 = ((REG4 << 24) | REG4) & UINT64_C(0x000000FF000000FF);

		REG1 = ((REG1 << 12) | REG1) & UINT64_C(0x000F000F000F000F);
		REG2 = ((REG2 << 12) | REG2) & UINT64_C(0x000F000F000F000F);
		REG3 = ((REG3 << 12) | REG3) & UINT64_C(0x000F000F000F000F);
		REG4 = ((REG4 << 12) | REG4) & UINT64_C(0x000F000F000F000F);

		REG1 = ((REG1 <<  6) | REG1) & UINT64_C(0x0303030303030303);
		REG2 = ((REG2 <<  6) | REG2) & UINT64_C(0x0303030303030303);
		REG3 = ((REG3 <<  6) | REG3) & UINT64_C(0x0303030303030303);
		REG4 = ((REG4 <<  6) | REG4) & UINT64_C(0x0303030303030303);

		REG1 = ((REG1 <<  3) | REG1) & UINT64_C(0x1111111111111111);
		REG2 = ((REG2 <<  3) | REG2) & UINT64_C(0x1111111111111111);
		REG3 = ((REG3 <<  3) | REG3) & UINT64_C(0x1111111111111111);
		REG4 = ((REG4 <<  3) | REG4) & UINT64_C(0x1111111111111111);
